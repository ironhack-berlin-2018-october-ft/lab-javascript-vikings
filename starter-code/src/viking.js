...
class War {
    ...
    vikingAttack(){
        ...
        var BattleResult = saxonDefender.receiveDamage(vikingAttacker.strength);
        if (BattleResult === "A Saxon has died in combat") this.saxonArmy.splice(this.saxonArmy[place], 1); 
        return BattleResult;
    }
